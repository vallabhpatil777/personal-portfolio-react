...
import './navbar.css'
import logo from '/Users/vallabhpatil777/Documents/portfolio/portfolio/src/assets/logo.PNG'
...
<Link className='listItem' onClick={()=>setShowMenu(!showMenu)}>Portfolio</Link>
